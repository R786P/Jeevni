<?php
// यह फाइल CodePen से लिया गया पूरा कोड है
// इसे InfinityFree पर काम करने के लिए index.php के रूप में सेव करें
?>
<!DOCTYPE html>
<html lang="hi">
<head>
                ...
                <div class="stories-grid">
                    <div class="story-card">
                        <div class="story-content">
                            <div>
                                <span class="story-category">लव लॉस</span>
                                <span class="story-date">2024-01-15</span>
                            </div>
                            <h3 class="story-title">प्रेम विरह की यात्रा</h3>
                            <p class="story-excerpt">
                                जब मैंने उसे अंतिम बार देखा, मेरा दिल टूट गया था। लेकिन आज मैं जानता हूँ कि हर अंधेरे के बाद सुबह आती है...
                            </p>
                    ...
                    <div class="story-card">
                        <div class="story-content">
                            <div>
                                <span class="story-category">आत्म-विकास</span>
                                <span class="story-date">2024-01-14</span>
                            </div>
                            <h3 class="story-title">आत्मविश्वास की नई शुरुआत</h3>
                            <p class="story-excerpt">
                                मैंने कभी नहीं सोचा था कि मैं इतनी मजबूत हो सकती हूँ। आज मैं अपने आप पर गर्व महसूस करती हूँ...
                            </p>
                            <div class="story-meta">
                                <span>लेखक: प्रियंका</span>
                                <div class="story-actions">
                                    <div class="story-action">
                                        <span>❤️</span>
                                        <span>32</span>
        ...
        <div id="stories" class="content-tab">
            ...
            <div class="stories-grid">
                ...
                <div class="story-card">
                    <div class="story-content">
                        <div>
                            <span class="story-category">परिवार</span>
                            <span class="story-date">2024-01-13</span>
                        </div>
                        <h3 class="story-title">परिवार के साथ संघर्ष</h3>
                        <p class="story-excerpt">
                            परिवार के बीच तनाव ने मुझे बहुत प्रभावित किया, लेकिन मैंने सीखा कि कैसे अपने लिए खड़ा होना है...
                        </p>
                        <div class="story-meta">
                            <span>लेखक: अनाम</span>
                            <div class="story-actions">
